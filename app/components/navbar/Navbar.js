        ...
        <div className=" mt-24 flex-col justify-center text-center">
          ...
          <div className=" pl-72 pr-64 mt-12 text-xl font-semi-bold mb-6">
            <p>
              ...
              with care and attention. In addition to considering the cost,
              time, and scope, the relationship between the client and the
              agency is also crucial in maintaining a balance.
            </p>
          </div>
        </div>
      </div>
